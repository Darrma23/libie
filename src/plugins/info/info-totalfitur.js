...
handler.desc = [
  "Menampilkan statistik total fitur bot",
  "Menghitung jumlah seluruh command yang tersedia",
  "Menampilkan total kategori atau tag plugin",
  "Menampilkan total plugin yang dimuat di sistem",
  "Memberikan gambaran skala dan kelengkapan bot"
];
