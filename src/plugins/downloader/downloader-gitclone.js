...
handler.desc = [
  "Mengunduh repository GitHub dalam bentuk file ZIP",
  "Mendukung URL repository GitHub standar",
  "Mengekstrak nama user dan repo secara otomatis",
  "Menggunakan API resmi GitHub untuk download",
  "Mengirim file ZIP langsung ke chat",
  "Cocok untuk backup atau ambil source code cepat"
];
