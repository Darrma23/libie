...
handler.desc = [
  "Berinteraksi dengan Felo AI untuk tanya jawab berbasis teks",
  "Menghasilkan jawaban AI lengkap dengan sumber referensi",
  "Menampilkan hingga 10 sumber dengan judul dan URL",
  "Cocok untuk pertanyaan faktual dan riset ringan",
  "Menggunakan API pihak ketiga (nekolabs)",
  "Menangani error API dan respons kosong dengan aman"
];
